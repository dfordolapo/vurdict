              ...
              <div className="px-5 py-4 border-t border-slate-100 bg-white">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-base sm:text-xs text-slate-800 placeholder:text-xs placeholder-slate-400 focus:outline-none focus:border-indigo-300 focus:bg-white transition-all"
                  />
                  <button
                    onClick={handleSend}
                    disabled={!input.trim()}
