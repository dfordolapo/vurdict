        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-10">
            <div className="max-w-xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex items-center gap-2">
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-brand-indigo to-brand-violet flex items-center justify-center shadow-lg shadow-brand-indigo/20">
                    <MessageSquare size={18} className="text-white" />
                  </div>
                  <span className="text-xl font-bold text-white tracking-tight">
                    <span className="text-gradient-brand">Re:</span>Vurdict
                  </span>
                </div>
            ...
            <div className="flex flex-col gap-3 w-full md:w-auto">
              <Link
                href="/analyze"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand-indigo to-brand-violet hover:from-brand-indigo hover:to-brand-indigo/90 px-6 py-3 text-xs font-bold text-white shadow-lg shadow-brand-indigo/20 transition-all duration-200 hover:scale-[1.01] group"
              >
                <Sparkles size={14} />
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-xs font-bold text-slate-400 border border-navy-800 hover:border-brand-indigo/40 hover:text-white hover:bg-navy-900/60 transition-all"
              >
                <Lightbulb size={14} />
          ...
          <div className="rounded-2xl border border-navy-800/80 bg-navy-900/40 shadow-2xl overflow-hidden">
            ...
            <div className="px-5 py-4 border-b border-navy-800 bg-navy-900/80 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-brand-indigo to-brand-violet flex items-center justify-center">
            ...
            <div className="px-5 py-6 space-y-5 max-h-[420px] overflow-y-auto">
              {messages.map((msg, idx) => (
                <div key={idx} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  {msg.role === 'assistant' && (
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-brand-indigo to-brand-violet flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex gap-3 justify-start animate-fade-in-up">
                  ...
                  <div className="max-w-[75%] rounded-2xl px-5 py-4 bg-navy-950/80 border border-brand-indigo/30 text-slate-300 rounded-tl-md">
                    <div className="flex items-center gap-2 mb-2">
                      <MessageSquare size={13} className="text-brand-indigo" />
            ...
            {[
              ...
              return (
                <div key={idx} className="glass-panel-interactive rounded-2xl p-5 text-left">
                  <Icon size={18} className="text-brand-indigo mb-3" />
          ...
          {/* Ecosystem CTA */}
          <div className="mt-12 bg-gradient-to-br from-brand-indigo/5 to-brand-violet/5 border border-brand-indigo/10 rounded-2xl p-8 text-center">
            <h2 className="text-lg font-extrabold text-white mb-2">Two Products, One Ecosystem</h2>
            <p className="text-sm text-slate-400 max-w-lg mx-auto leading-relaxed mb-6 font-medium">
